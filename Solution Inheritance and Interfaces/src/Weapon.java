public class Weapon extends Item implements iDestructable, iSellable, iReparable{

    private Integer totalDamage;
    private boolean usable;

    public Weapon(String name, String description, Integer quantity, Integer price) {
